...
var e = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
    ...
    return n(i, [ {
        ...
        value: function(t, e, n) {
            this.scope = n;
            var i = n.detail.value, r = null !== i[t] && void 0 !== i[t] ? i[t] : "";
            for (var a in e) if (this.isValidMethod(a)) {
                var o = {
                    method: a,
                    parameters: e[a]
                }, u = this.methods[a](r, o.parameters);
                if ("dependency-mismatch" === u) continue;
                if (this.setValue(t, a, u, r), !u) {
                    this.formatTplAndAdd(t, o, r);
                    break;
                }
            }
        }
